...
count = 100 # step numbers
frames_per_step = 1 # number of image captured at each stop
exposure = 100  # ms
file_prefix = 'IMG_'


# PIZStage, TIPFSOffset, TIZDrive change z scan device between these three
...
initial_pos=None
if z_device=='TIZDrive':
    mmc.loadDevice('TIZDrive','NikonTI','TIZDrive')

elif z_device=='TIPFSOffset':
...
fp=open('position.txt','w')  # save position of the z device to txt file
file_count = 0
